...
class RWMB_File_Field extends RWMB_Field {
	...
	public static function ajax_delete_file() {
		...
		$field_id = $request->filter_post( 'field_id', FILTER_SANITIZE_FULL_SPECIAL_CHARS );
		check_ajax_referer( "rwmb-delete-file_{$field_id}" );

		// Make sure the file to delete is in the custom field.
		$attachment  = $request->post( 'attachment_id' );
		$object_id   = $request->filter_post( 'object_id', FILTER_SANITIZE_FULL_SPECIAL_CHARS );
		$object_type = $request->filter_post( 'object_type', FILTER_SANITIZE_FULL_SPECIAL_CHARS );
