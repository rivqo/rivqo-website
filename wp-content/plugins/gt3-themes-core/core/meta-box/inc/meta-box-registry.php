...
class RWMB_Meta_Box_Registry {
	 ...
	 * @return \RW_Meta_Box_GT3
	 */
	public function make( $settings ) {
		$class_name = apply_filters( 'rwmb_meta_box_class_name', 'RW_Meta_Box_GT3', $settings );
	 ...
	 *
	 * @param RW_Meta_Box_GT3 $meta_box Meta box instance.
	 */
	public function add( RW_Meta_Box_GT3 $meta_box ) {
	 ...
	 *
	 * @return RW_Meta_Box_GT3 | bool False or meta box object.
	 */
