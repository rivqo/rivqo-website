	...
	if($settings['headlines_style'] == 'highlighter') {
		switch($settings['highlighter_shap']) {
			...
			case 'curved':
				...
				break;
			case 'doubled':
				$shape = '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 500 150" preserveAspectRatio="none"><path d="m37,146.4l141.3,-28.6c130.2,-11 232.2,-3.3 297.7,4.6"/><path d="m113.9,142.8c49.1,-17.1 91,-29.3 127.2,-29.1c68.5,-2.8 114.9,-1.8 177.9,7.4" /></svg>';
				break;
			case 'zigzagged':
				$shape = '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 500 150" preserveAspectRatio="none"><path d="m20.3,127.3c49.3,-3 142.7,-12.6 187.7,-12.4c120.9,-5.6 176.9,4.4 269.3,11.2c-122.2,-0.5 -274.1,-4.5 -385.3,8.9c80.6,-1.9 234.2,1 313.9,5.3c-56,1.4 -152.2,0.7 -216.1,8" /></svg>';
				break;
			default:
			case 'underlined':
				$shape = '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 500 150" preserveAspectRatio="none"><path d="m20.69998,137.6c102.29522,-15.6 261.64822,-20.4 358.75135,-15.3c40.43563,3.2 77.13684,8.8 100.8487,19.7" /></svg>';
				break;
		}
	}
