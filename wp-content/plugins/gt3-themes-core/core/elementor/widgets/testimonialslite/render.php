                    ...
                    <div class="testimonials_avatar_item">
						<div class="testimonials_avatar_content">
							...
							if(!empty($item['image']['id'])) {
								...
								$image_obj_alt = '';
								if (!empty($image_obj['alt'])) {
									$image_obj_alt = $image_obj['alt'];
								}

								$photo = '<div class="testimonials_photo"><img '.$widget->get_render_attribute_string($repeater_key).' alt="'.$image_obj_alt.'" /></div>';
							}
