...
$widget->add_control(
	'btn_color_hover',
	array(
		'label'       => esc_html__( 'Button color (Hover)', 'gt3_themes_core' ),
		'type'        => Controls_Manager::COLOR,
		'description' => esc_html__( 'Select custom color for button', 'gt3_themes_core' ),
		'selectors'   => array(
...
$widget->add_control(
	'btn_bg_color_hover',
	array(
		'label'       => esc_html__( 'Button Background Color (Hover)', 'gt3_themes_core' ),
		'type'        => Controls_Manager::COLOR,
		'description' => esc_html__( 'Select custom color for button', 'gt3_themes_core' ),
		'selectors'   => array(
...
$widget->add_responsive_control(
	...
	array(
		'label'     => esc_html__( 'Border Color (Hover)', 'gt3_themes_core' ),
		'type'      => Controls_Manager::COLOR,
		'condition' => array(
			'button_border_en!' => '',
			'button_border!'    => '',
