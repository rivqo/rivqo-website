...
$widget->add_responsive_control(
	...
	array(
		...
		'mobile_default' => 1,
		'selectors'      => array(
			'body:not(.gt3_modern_shop) {{WRAPPER}} .woocommerce ul.products:not(.list) li.product' => 'width: calc(100%/{{VALUE}} - {{grid_gap.SIZE}}{{grid_gap.UNIT}});',
		),
	)
);
...
$widget->add_control(
	...
	array(
		...
		'selectors'  => array(
			'body:not(.gt3_modern_shop) {{WRAPPER}} .woocommerce ul.products' => 'margin-right: -{{SIZE}}{{UNIT}};',
			'body:not(.gt3_modern_shop) {{WRAPPER}} .woocommerce li.product'  => 'margin-right: {{SIZE}}{{UNIT}};margin-bottom: {{SIZE}}{{UNIT}};',
		),
	)
);
