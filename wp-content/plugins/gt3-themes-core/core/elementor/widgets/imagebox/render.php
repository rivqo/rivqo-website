...
if (!empty($settings['_background_hover_image']['url'])) {
    ...
    $background_hover_position = (!empty($settings['_background_hover_position'])) ? $settings['_background_hover_position'] : '';
    $background_hover_attachment = (!empty($settings['_background_hover_attachment'])) ? $settings['_background_hover_attachment'] : '';
    $background_hover_repeat = (!empty($settings['_background_hover_repeat'])) ? $settings['_background_hover_repeat'] : '';
    $background_hover_size = (!empty($settings['_background_hover_size'])) ? $settings['_background_hover_size'] : '';
    $background_hover_transition = (!empty($settings['background_hover_transition'])) ? $settings['background_hover_transition'] : '';
...
if (!empty($settings['_background_image']['url'])) {
    ...
    $background_position = (!empty($settings['_background_position'])) ? $settings['_background_position'] : '';
    $background_attachment = (!empty($settings['_background_attachment'])) ? $settings['_background_attachment'] : '';
    $background_repeat = (!empty($settings['_background_repeat'])) ? $settings['_background_repeat'] : '';
    $background_size = (!empty($settings['_background_size'])) ? $settings['_background_size'] : '';
