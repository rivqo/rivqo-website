...
if ( !post_password_required() ) {
	...
	$layout = apply_filters('gt3_archive_pf_sidebar_layout', gt3_option('page_sidebar_layout'));
	$sidebar = apply_filters('gt3_archive_pf_sidebar_default', gt3_option('page_sidebar_def'));
	$column = 12;
