<?php
namespace MASCOTCOREAMISO\CPT\PageTitle;
 ...
 * Singleton class
 * class CPT_PageTitle
 * @package MASCOTCOREAMISO\CPT\PageTitle;
 */
final class CPT_PageTitle implements Lib\Mascot_Core_Amiso_Interface_PostType {
	...
	private function __construct() {
		$this->ptSingularName = esc_html__( 'Parts - Page Title', 'mascot-core-amiso' );
		$this->ptPluralName = esc_html__( 'Parts - Page Title', 'mascot-core-amiso' );
	...
	public function customColumnsSettings( $columns ) {
		...
		$columns = array(
			...
			'active-page-title'	=> esc_html__( 'Currently Active Page Title', 'mascot-core-amiso' ),
		...
		switch( $columns ) {
			case 'active-page-title' :
				if( mascot_core_amiso_theme_installed() ) {
					$active_headertop_id = amiso_get_redux_option( 'page-title-settings-choose-page-title-cpt-widget-area', 'default' );
