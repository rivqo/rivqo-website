<?php
namespace MascotCoreAmiso\Widgets\Services;
 ...
 * @since 1.0.0
 */
class TM_Elementor_Services extends Widget_Base {
	public function __construct($data = [], $args = null) {
		parent::__construct($data, $args);
		wp_register_style( 'mascot-flaticon-set-business', MASCOT_CORE_AMISO_URL_PATH . 'assets/flaticon-set-business/style.css' );

		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			$direction_suffix = is_rtl() ? '.rtl' : '';
			wp_enqueue_style( 'tm-services-style', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/services/services-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Services Grid', 'mascot-core-amiso' );
	}
	...
	public function get_style_depends() {
		return [ 'mascot-flaticon-set-business' ];
	}
	...
	protected function register_skins() {
		...
		$this->add_skin( new Skins\Skin_Style_Mouse_Hover_Cursor_Effect( $this ) );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'service_icons_options', [
				'label' => esc_html__( 'Service Icons & Custom Title', 'mascot-core-amiso' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater->add_control(
			'icon_for_service',
			[
				'label' => __( 'For Service', 'mascot-core-amiso' ),
				'type' => Controls_Manager::SELECT2,
				'options' => $this->get_supported_ids(),
				'label_block' => true,
				'multiple' => false,
		...
		$this->add_control(
			'service_icon_array',
			[
				'label' => esc_html__( "Service Icons", 'mascot-core-amiso' ),
		...
		$this->add_control(
			'show_service_icon', [
				'label' => esc_html__( "Show Service Icon", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .type-services .title' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services .title:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .type-services .title a:hover' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services:hover .title' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services .title' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services .title:hover' => 'color: var(--theme-color{{VALUE}});',
					'{{WRAPPER}} .type-services .title a:hover' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services:hover .title' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .type-services .title',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services .excerpt' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services:hover .excerpt' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services .excerpt' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services:hover .excerpt' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'mascot-core-amiso' ),
				'selector' => '{{WRAPPER}} .type-services .excerpt',
			]
		);
		$this->add_responsive_control(
			'excerpt_margin',
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .excerpt' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services .content' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services:hover .content' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services .content' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services:hover .content' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			'service_icon_custom_styling',
			[
				'label' => esc_html__( 'Service Icon Custom Styling', 'mascot-core-amiso' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'mascot-core-amiso' ),
				'selector' => '{{WRAPPER}} .type-services .icon i',
			]
		);
		$this->add_responsive_control(
			'service_icon_margin',
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'service_icon_area_color_options',
			[
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services .icon' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			'service_icon_theme_colored_hover',
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}:hover .type-services .icon' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			'service_icon_custom_color',
			[
				'label' => esc_html__( "Icon Custom Color", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services .icon i' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			'service_icon_custom_color_hover',
			[
				'label' => esc_html__( "Icon Custom Color (Hover)", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}:hover .type-services .icon i' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			'service_icon_area_bg_options',
			[
		...
		$this->add_control(
			'service_icon_area_bg_theme_colored',
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .type-services .icon' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			'service_icon_area_bg_theme_colored_hover',
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}:hover .type-services .icon' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			'service_icon_area_custom_bg_color',
			[
				'label' => esc_html__( "Icon BG Custom Color", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .type-services .icon' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			'service_icon_area_custom_bg_color_hover',
			[
				'label' => esc_html__( "Icon BG Custom Color (Hover)", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}:hover .type-services .icon' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_control(
			'service_icon_area_dimension_options',
			[
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .type-services .service-icon' => 'width: {{SIZE}}{{UNIT}};',
				]
			]
		);
		$this->add_responsive_control(
			'service_icon_area_height',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .type-services .service-icon' => 'height: {{SIZE}}{{UNIT}};',
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .type-services .service-icon i' => 'line-height: {{SIZE}}{{UNIT}};',
				]
			]
		);
		$this->add_control(
			'service_icon_area_border_options',
			[
		...
		$this->add_group_control(
			...
			[
				'name' => 'service_icon_area_border',
				'label' => esc_html__( 'Border', 'mascot-core-amiso' ),
				'selector' => '{{WRAPPER}} .type-services .service-icon',
			]
		);
		$this->add_responsive_control(
			'service_icon_area_border_radius',
			[
				'label' => esc_html__( "Border Radius", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .type-services .service-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'service_icon_area_box_shadow',
	...
	public function sercice_custom_icon_img($settings) {
		$service_icon_array_new = array();
		$service_title_array_new = array();
		if ( $settings['service_icon_array'] ) :
			foreach (  $settings['service_icon_array'] as $key => $each_item ) {
				$service_icon_array_new[$each_item['icon_for_service']]['icon_type'] = $each_item['icon_type'];
				$service_icon_array_new[$each_item['icon_for_service']]['icon'] = $each_item['service_icon'];
				$service_icon_array_new[$each_item['icon_for_service']]['img'] = $each_item['service_image'];
				$service_icon_array_new[$each_item['icon_for_service']]['img_hover'] = $each_item['service_image_hover'];
				$service_title_array_new[$each_item['icon_for_service']] = $each_item['custom_title'];
			}
		endif;
		$settings['service_icon_array_new'] = $service_icon_array_new;
		$settings['service_title_array_new'] = $service_title_array_new;
	...
	protected function render() {
		...
		$settings = $this->sercice_custom_icon_img( $settings );
	...
	public function render_output( $class_instance, $settings ) {
		...
		//enqueue css
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-service-skin-style1', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/services/service-skin-style1' . $direction_suffix . '.css' );
