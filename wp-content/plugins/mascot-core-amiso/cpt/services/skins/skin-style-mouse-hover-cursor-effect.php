...
class Skin_Style_Mouse_Hover_Cursor_Effect extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-style-mouse-hover-cursor-effect';
	}


	public function get_title() {
		return __( 'Skin - Style Mouse Hover Cursor Effect', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-service-skin-mouse-hover-cursor-effect', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/services/service-skin-mouse-hover-cursor-effect' . $direction_suffix . '.css' );
		...
		$html = mascot_core_amiso_get_cpt_shortcode_template_part( 'each-item', $settings['_skin'], 'services/tpl', $settings, true );
