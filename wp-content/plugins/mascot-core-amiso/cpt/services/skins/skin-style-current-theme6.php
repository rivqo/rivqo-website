...
class Skin_Style_Current_Theme6 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme6', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-service-skin-current-theme6', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/services/service-skin-current-theme6' . $direction_suffix . '.css' );
