...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .service-inner' => 'background-color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .service-inner' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .service-inner' => 'border-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .service-inner' => 'border-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .icon-box' => 'background: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .icon-box' => 'background: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .icon-box .icon i' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .icon-box .icon i' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);

		$this->add_control(
			'button_wrapper_bg_color_options',
			[
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Text Color", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .read-more' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .service-item-current-style1 .read-more i',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .service-inner:hover' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1:hover .service-inner' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1 .service-inner:hover' => 'border-color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1:hover .service-inner' => 'border-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1:hover .icon-box' => 'background: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1:hover .icon-box' => 'background: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1:hover .icon-box .icon i' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1:hover .icon-box .icon i' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		...
		$this->add_control(
			'button_wrapper_bg_color_options_hover',
			[
				'label' => esc_html__( 'Button Options (Hover)', 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .service-item-current-style1:hover .read-more' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_group_control(
			\Elementor\Group_Control_Box_Shadow::get_type(),
			[
				'name' => 'service_icon_area_box_shadow_hover',
				'label' => esc_html__( 'Box Shadow', 'mascot-core-amiso' ),
				'selector' => '{{WRAPPER}} .service-item-current-style1:hover .read-more i',
			]
		);
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-service-skin-current-theme1', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/services/service-skin-current-theme1' . $direction_suffix . '.css' );
