...
class Skin_Style_Current_Theme5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme5', 'mascot-core-amiso' );
	}
	...
	public function render() {
		...
		$settings = $this->parent->project_custom_icon_img( $settings );
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme5', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/projects/project-skin-current-theme5' . $direction_suffix . '.css' );
