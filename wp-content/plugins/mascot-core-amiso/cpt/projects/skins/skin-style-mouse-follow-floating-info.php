...
class Skin_Style_Mouse_Follow_Floating_Info extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Mouse Follow Floating Info', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-project-skin-mouse-follow-floating-info', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/projects/project-skin-mouse-follow-floating-info' . $direction_suffix . '.css' );
