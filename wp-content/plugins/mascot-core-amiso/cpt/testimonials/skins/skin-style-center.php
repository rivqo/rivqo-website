...
class Skin_StyleAllCenter extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-style-all-center';
	}


	public function get_title() {
		return __( 'Skin - Style All Center', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-testimonial-skin-style-all-center', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/testimonials/testimonial-skin-style-all-center' . $direction_suffix . '.css' );
