...
class Skin_Style_Current_Theme4 extends Elementor_Skin_Base {
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-testimonial-skin-current-theme4', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/testimonials/testimonial-skin-current-theme4' . $direction_suffix . '.css' );
