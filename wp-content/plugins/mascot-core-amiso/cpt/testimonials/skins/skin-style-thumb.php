...
class Skin_Style_Thumb extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-style-thumb';
	}


	public function get_title() {
		return __( 'Skin - Style Thumb', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-testimonial-skin-thumb', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/testimonials/testimonial-skin-thumb' . $direction_suffix . '.css' );
		...
		$html = mascot_core_amiso_get_cpt_shortcode_template_part( 'testimonials-thumb-carousel', null, 'testimonials/tpl', $settings, true );
