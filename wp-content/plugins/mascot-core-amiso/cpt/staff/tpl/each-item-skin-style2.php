		...
		<div class="team-content">
			...
			<div class="team-social">
				<?php if ( $show_social_link == 'yes' ) : ?>
					<ul class="<?php echo esc_attr( apply_filters( 'amiso_sc_staff_social_links', 'styled-icons icon-team-list icon-flat icon-md icon-dark icon-theme-colored1') ); ?>">
						<?php
