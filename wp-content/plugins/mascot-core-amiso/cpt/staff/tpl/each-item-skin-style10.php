<div <?php post_class( 'team-item' ); ?>>
	<div class="team-item-skin-style10">
		<div class="team-thumb">
			...
			<div class="team-social">
				<?php if ( $show_social_link == 'yes' ) : ?>
					<ul class="<?php echo esc_attr( apply_filters( 'amiso_sc_staff_social_links', 'styled-icons icon-team-list icon-circled icon-md icon-dark icon-theme-colored1') ); ?>">
						<?php
