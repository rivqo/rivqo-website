...
class Skin_Style9 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style9', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-staff-skin-style9', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/staff/staff-skin-style9' . $direction_suffix . '.css' );
