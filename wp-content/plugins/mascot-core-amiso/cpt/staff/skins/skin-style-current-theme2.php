...
class Skin_Style_Current_Theme2 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Current Wrapper Styling', 'mascot-core-amiso' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-current-theme2 .inner-box:before' => 'background-color: {{VALUE}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .team-current-theme2:hover .inner-box:before' => 'background-color: {{VALUE}};',
				]
			]
		);
		...
		$this->start_controls_section(
			'title_styling',
			[
				'label' => esc_html__( 'Title Current Styling', 'mascot-core-amiso' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Title Color", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .team-current-theme2 .inner-box .info-box .name' => 'color: {{VALUE}};',

				]
			]
		);
		$this->add_responsive_control(
			'title_custom_bg_color_hover',
			[
				'label' => esc_html__( "Custom Title Color (Hover)", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .team-current-theme2:hover .inner-box .info-box .name' => 'color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			'title_theme_colored',
			[
				'label' => esc_html__( "Make Title Colored", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .team-current-theme2 .inner-box .info-box .name' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Make Title Colored (Hover)", 'mascot-core-amiso' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .team-current-theme2:hover .inner-box .info-box .name' => 'color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->end_controls_section();
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-staff-skin-current-theme2', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/staff/staff-skin-current-theme2' . $direction_suffix . '.css' );
