...
class Skin_Style8 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style8', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-staff-skin-style8', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/staff/staff-skin-style8' . $direction_suffix . '.css' );
