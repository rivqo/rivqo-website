...
class Skin_Style10 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style10', 'mascot-core-amiso' );
	}
	...
	public function render_output( $class_instance, $settings ) {
		...
		wp_enqueue_style( 'tm-staff-skin-style10', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/cpt/staff/staff-skin-style10' . $direction_suffix . '.css' );
