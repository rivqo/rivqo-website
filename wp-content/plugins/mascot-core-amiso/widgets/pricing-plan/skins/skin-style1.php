...
class Skin_Pricing_Style1 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style1', 'mascot-core-amiso' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-award-block-style1', MASCOT_CORE_AMISO_URL_PATH . 'assets/css/shortcodes/pricing-plan/pricing-skin-style1' . $direction_suffix . '.css' );
