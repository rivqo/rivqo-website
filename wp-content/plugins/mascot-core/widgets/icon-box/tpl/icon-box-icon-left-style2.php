...
<div class="tm-sc-icon-box icon-box icon-left icon-left-style2 <?php if( !empty($classes) ) echo esc_attr(implode(' ', $classes)); ?>" <?php echo mascot_core_get_inline_attrs($svg_animation_data); ?>>
