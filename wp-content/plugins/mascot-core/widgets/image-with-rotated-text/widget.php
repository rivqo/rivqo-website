...
class TM_Elementor_Image_With_Rotated_Text extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-image-with-rotated-text-style', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/shortcodes/image-with-rotated-text' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Image With Rotated Text', 'mascot-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'paroller_styling',
			[
				'label' => esc_html__( 'Rotated Text Options', 'mascot-core' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'text_position',
			[
				'label' => esc_html__( "Text Position", 'mascot-core' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'top-left'      => esc_html__( 'Top Left', 'mascot-core' ),
					'bottom-left' => esc_html__( 'Bottom Left', 'mascot-core' ),
					'top-right'      => esc_html__( 'Top Right', 'mascot-core' ),
					'bottom-right' => esc_html__( 'Bottom Right', 'mascot-core' )
				],
				'default' => 'top-left',
			]
		);
	...
	protected function render() {
		...
		$html = mascot_core_get_shortcode_template_part( 'image-with-rotated-text', null, 'image-with-rotated-text/tpl', $settings, true );
