...
class TM_Elementor_FullPage extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'scrolloverflow', MASCOT_CORE_ELEMENTOR_ASSETS_URI . '/js/plugins/slider-fullpage/scrolloverflow.min.js', array('jquery'), false, true );
		wp_register_script( 'fullpage', MASCOT_CORE_ELEMENTOR_ASSETS_URI . '/js/plugins/slider-fullpage/fullpage.min.js', array('jquery'), false, true );


		wp_register_style( 'jquery-fullpage', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/js/plugins/slider-fullpage/fullpage.min' . $direction_suffix . '.css' );
		wp_register_style( 'tm-full-page-slider-style', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/extend-plugins/full-page-slider/full-page-slider' . $direction_suffix . '.css' );
	...
	public function get_title() {
		return esc_html__( 'Slider - FullPage', 'mascot-core' );
	}
	...
	public function get_style_depends() {
		return [ 'jquery-fullpage', 'tm-full-page-slider-style' ];
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'fp_auto_height', [
				'label' => esc_html__( "Make Auto Height Section", 'mascot-core' ),
		...
		$repeater->add_control(
			'fp_auto_height_responsive', [
				'label' => esc_html__( "Make Responsive Auto Height Section", 'mascot-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'show_navigation_landscape_slider', [
				'label' => esc_html__( "Show Navigation for Each Landscape Slider", 'mascot-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no'
			]
		);
	...
	protected function render() {
		...
		if ( $settings['multiscroll_items'] ) { 
			...
			foreach (  $settings['multiscroll_items'] as $item ) {
				...
				$html .= mascot_core_get_shortcode_template_part( 'slider-content-item', null, 'slider-fullpage/tpl', $item, true );
				$html .= '</div>';
			}
		}
