...
class Skin_Pricing_Style2 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/tm-ele-pricing-table/sub_title_options/after_section_end', [ $this, 'register_layout_controls' ] );
	}
	...
	public function get_title() {
		return __( 'Skin Pricing Style2', 'mascot-core' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Title Head Section Options', 'mascot-core' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Head Background', 'mascot-core' ),
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .tm-sc-pricing-table .pricing-table-head',
			]
		);
		$this->add_control(
			'title_head_section_bg_theme_colored',
			[
				'label' => esc_html__( "Head BG Theme Colored", 'mascot-core' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-sc-pricing-table .pricing-table-head' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Head BG Theme Colored (Hover)", 'mascot-core' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_theme_color_list(),
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}:hover .tm-sc-pricing-table .pricing-table-head' => 'background-color: var(--theme-color{{VALUE}});'
				],
			]
		);
		$this->add_responsive_control(
			'wrapper_padding',
			[
				'label' => esc_html__( 'Head Padding', 'mascot-core' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .tm-sc-pricing-table .pricing-table-head' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
