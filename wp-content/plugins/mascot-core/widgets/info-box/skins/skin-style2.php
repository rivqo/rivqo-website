...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 2', 'mascot-core' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style2', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/shortcodes/info-box/info-box-skin2' . $direction_suffix . '.css' );
