...
class Skin_style4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 4', 'mascot-core' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style4', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/shortcodes/info-box/info-box-skin4' . $direction_suffix . '.css' );
