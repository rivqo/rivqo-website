...
class Skin_style9 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 9', 'mascot-core' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style9', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/shortcodes/info-box/info-box-skin9' . $direction_suffix . '.css' );
