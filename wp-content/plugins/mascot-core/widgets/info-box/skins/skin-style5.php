...
class Skin_style5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 5', 'mascot-core' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style5', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/shortcodes/info-box/info-box-skin5' . $direction_suffix . '.css' );
