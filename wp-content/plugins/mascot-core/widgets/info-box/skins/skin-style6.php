...
class Skin_style6 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 6', 'mascot-core' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style6', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/shortcodes/info-box/info-box-skin6' . $direction_suffix . '.css' );
