...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 3', 'mascot-core' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style3', MASCOT_CORE_ELEMENTOR_URL_PATH . 'assets/css/shortcodes/info-box/info-box-skin3' . $direction_suffix . '.css' );
