(function($) {
  ...
  $(window).on("elementor/frontend/init", function () {
      elementorFrontend.hooks.addAction(
          "frontend/element_ready/tm-ele-pricing-switcher.default",
          TM_Pricing_Switcher_Smart
      );
      elementorFrontend.hooks.addAction(
          "frontend/element_ready/tm-ele-pricing-switcher.skin-style1",
          TM_Pricing_Switcher_Smart
      );
      elementorFrontend.hooks.addAction(
          "frontend/element_ready/tm-ele-pricing-switcher.skin-style2",
