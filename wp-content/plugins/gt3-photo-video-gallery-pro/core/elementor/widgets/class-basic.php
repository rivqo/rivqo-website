...
abstract class Basic extends Widget_Base {
	...
	protected function lightboxControls(array $condition = array( 'linkTo' => 'lightbox' )){
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__('Autoplay Duration (seconds)', 'gt3pg_pro'),
				'type'      => Controls_Manager::NUMBER,
				'min'       => 1,
				'default'   => 6,
				'condition' => array(
		...
		$this->add_control(
			'lightboxContinuous',
			array(
				'label'       => esc_html__('Loop', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
		...
		$this->add_control(
			'lightboxCover',
			array(
				'label'       => esc_html__('Image Scalling', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
		...
		$this->add_control(
			'ytWidth',
			array(
				'label'       => esc_html__('YouTube Width', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
		...
		$this->add_control(
			'lightboxVideoAutoplay',
			array(
				'label'       => esc_html__('Video Autoplay', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
		...
		$this->add_control(
			'lightboxToggleControlsOnSlideClick',
			array(
				'label'       => esc_html__('Hide Controls', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
		...
		$this->add_control(
			'lightboxCloseOnSlideClick',
			array(
				'label'       => esc_html__('Close on Slide Click', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__('Animation Effects', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
		...
		$this->add_control(
			'lightboxSimpleStyle',
			array(
				'label'       => esc_html__('Simple Style', 'gt3pg_pro'),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'default' => esc_html__('Default', 'gt3pg_pro'),
