...
add_action('elementor/element/gt3-core-processbar/basic_section/before_section_end', function($element,$args){
	$element->add_control(
		'modern_style',
		array(
			'label'       => esc_html__('Modern Style?', 'ewebot'),
			'type'        => Elementor\Controls_Manager::SWITCHER,
			'description' => esc_html__('If checked, enable modern style', 'ewebot'),
			'default'     => '',
			'prefix_class' => 'gt3_process_modern-',
			'condition'  => array(
				'vertical_style' => '2',
			),
		),
...
add_action('elementor/element/gt3-core-TestimonialsLite/general_section/before_section_end', function($element,$args){
	$element->add_control(
		'testimonials_quote',
		array(
			'label' => esc_html__('Disable Quote Icon', 'ewebot'),
			'type'  => Elementor\Controls_Manager::SWITCHER,
...
add_action('elementor/element/gt3-core-blogboxed/style_section/before_section_end', function($element,$section_id){
	$element->add_control(
		'block_rounded',
		array(
			'label' => esc_html__('Disable Items Rounded', 'ewebot'),
			'type'  => Elementor\Controls_Manager::SWITCHER,
