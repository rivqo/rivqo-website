...
add_filter(
	'gt3/core/customizer/convert_fields', function($fields){
		...
		'page_title_meta_color'              => Types::TYPE_COLOR,
		...
		'single_media_featured'              => Types::TYPE_BOOL,
