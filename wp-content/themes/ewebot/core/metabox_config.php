...
function gt3_pteam_meta_boxes( $meta_boxes ) {
    $meta_boxes[] = array(
        ...
        'fields'     	=> array(
	        array(
		        'id'   			=> 'mb_team_options_elementor',
		        'name' 			=> esc_html__( 'Add All Team Content in Elementor', 'ewebot' ),
		        'type'      => 'switch',
		        'style'     => 'rounded',
	        ),
        	array(
...
function gt3_blog_meta_boxes( $meta_boxes ) {
	$meta_boxes[] = array(
		...
		'fields'     	=> array(
			...
			array(
				'id'   			=> 'mb_post_disable_feature_image',
				'name' 			=> esc_html__( 'Disable featured image on the single post', 'ewebot' ),
				'type' 			=> 'checkbox',
			),
