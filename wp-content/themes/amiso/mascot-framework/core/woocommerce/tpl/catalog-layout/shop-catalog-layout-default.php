...
add_action( 'woocommerce_after_shop_loop_item_title', 'amiso_catalog_default_product_title', 5 );
add_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_price', 7 );
add_action( 'woocommerce_after_shop_loop_item_title', 'amiso_catalog_default_product_cat', 10 );



//title
if ( ! function_exists( 'amiso_catalog_default_product_title' ) ) {
	/**
	 * Add some HTML codes
	 *
	 */
	function amiso_catalog_default_product_title() {
	?>
...
//category
if ( ! function_exists( 'amiso_catalog_default_product_cat' ) ) {
	/**
	 * Add some HTML codes
	 *
	 */
	function amiso_catalog_default_product_cat() {
	?>
