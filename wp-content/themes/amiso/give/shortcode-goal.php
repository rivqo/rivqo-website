	   ...
	   <div class="raised">
			...
			if ( 'amount' === $goal_format ) :
				...
				echo sprintf(
					...
					wp_kses(
						__( '<span class="income" data-amounts="%1$s">%2$s</span> of <span class="goal-text" data-amounts="%3$s">%4$s</span> raised', 'amiso' ),
						array (
							'span' => array (
								'class' => array(),
								'data-amounts' => array(),
				...
				<!-- <ul class="donation-info">
					<li class="goal"><span class="label"><?php esc_html_e( 'Goal', 'amiso' ); ?></span><span class="value"><?php echo esc_html( $formatted_goal ); ?></span></li>
					<li class="raised"><span class="label"><?php esc_html_e( 'Raised', 'amiso' ); ?></span><span class="value"><?php echo esc_html( $formatted_income ); ?></span></li>
				</ul> -->
			<?php
		  ...
		  elseif ( 'percentage' === $goal_format ) :
				...
				echo sprintf( /* translators: %s: percentage of the amount raised compared to the goal target */
					wp_kses(
						__( '<span class="give-percentage">%s%%</span> funded', 'amiso' ),
						array (
							'span' => array (
								'class' => array(),
							)
